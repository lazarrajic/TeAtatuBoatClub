    ...
    <>
      <header className="sticky top-0 z-50 border-b border-navy/10 bg-white/85 backdrop-blur-md">
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-5 py-3">
          <Link to="/" className="flex items-center gap-2 font-extrabold text-navy">
            <img src={c.logo} data-cms="Nav - Brand - Logo" alt={c.company_name} className="h-9 w-auto" />
            <span className="hidden text-base sm:inline">{c.company_name}</span>
          </Link>
